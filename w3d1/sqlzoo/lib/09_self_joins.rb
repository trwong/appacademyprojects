...
def haymarket_and_leith
  ...
  execute(<<-SQL)
  SELECT DISTINCT a.company, a.num FROM routes a
  JOIN routes b ON (a.company = b.company AND a.num = b.num)
  WHERE a.stop_id = 115 AND
  b.stop_id = 137
  SQL
end
...
def craiglockhart_and_tollcross
  ...
  execute(<<-SQL)
  SELECT a.company, b.num FROM routes a
  JOIN routes b ON (a.company = b.company AND a.num = b.num)
  WHERE a.stop_id = (
    SELECT id FROM stops
    WHERE name = 'Craiglockhart'
...
def start_at_craiglockhart
  ...
  execute(<<-SQL)
  SELECT stops.name, b.company, b.num FROM routes a
  JOIN routes b ON (a.company = b.company AND a.num = b.num)
  JOIN stops ON (b.stop_id = stops.id)
  WHERE a.stop_id = (
    SELECT id FROM stops
    WHERE name = 'Craiglockhart'
  )
...
def craiglockhart_to_sighthill
  ...
  execute(<<-SQL)
  SELECT a.num, a.company, stops.name, b.num, b.company FROM routes a
  JOIN
  JOIN routes b ON
  SQL
end
