...
var _todo_api_util = __webpack_require__(177);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  console.log("asdf");
  window.testFunction = _todo_api_util.testFunction;
...
var configureStore = function configureStore() {
  return (0, _redux.createStore)(_root_reducer2.default, (0, _redux.applyMiddleware)(_thunk.thunkMiddleware));
};
...
var _todo_list = __webpack_require__(59);
...
var TodoForm = function (_React$Component) {
  ...
  function TodoForm(prop) {
    ...
    var _this = _possibleConstructorReturn(this, (TodoForm.__proto__ || Object.getPrototypeOf(TodoForm)).call(this, prop));
  ...
  _createClass(TodoForm, [{
    key: 'linkState',
    value: function linkState(word) {
      var _this2 = this;

      return function (event) {
        return _this2.setState(_defineProperty({}, word, event.currentTarget.value));
      };
    }
  }, {
    key: 'submitForm',
    value: function submitForm(event) {
      event.preventDefault();
      var newState = Object.assign({}, this.state, { id: (0, _util.uniqueId)() });
      // debugger;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          'Title:',
          _react2.default.createElement('input', { onChange: this.linkState('title'), value: this.state.title })
        ),
        _react2.default.createElement(
          'label',
          null,
          'Body:',
          _react2.default.createElement('input', { onChange: this.linkState('body'), value: this.state.body })
        ),
